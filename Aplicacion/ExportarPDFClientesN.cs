...
{
    public class ExportarPDFClientesN
    {
        ...
        public class Manejador: IRequestHandler<Consulta, Stream>{
            ...
            {
                //Origen de datos
                var customers =  await context.Vclientes.ToListAsync();
                ...
                PdfPCell celda = new PdfPCell(new Phrase("Lista de Clientes", fuenteTitulo));
                ...
                PdfPCell celdaID = new PdfPCell(new Phrase("ID Clientes", fuenteEncabezado));
                tablaDatos.AddCell(celdaID);
                PdfPCell celdaCompania = new PdfPCell(new Phrase("Cedula", fuenteEncabezado));
                ...
                foreach(var customer in customers){
                    PdfPCell celdaDatoID = new PdfPCell(new Phrase(customer.IdClientes.ToString(), fuenteDatos));
                    tablaDatos.AddCell(celdaDatoID);

                    PdfPCell celdaDatoCompania = new PdfPCell(new Phrase(customer.Cedula, fuenteDatos));
                    tablaDatos.AddCell(celdaDatoCompania);

                    PdfPCell celdaDatoTitulo = new PdfPCell(new Phrase(customer.Nombre, fuenteDatos));
                    tablaDatos.AddCell(celdaDatoTitulo);
                    
                    PdfPCell celdaDatoContacto = new PdfPCell(new Phrase(customer.Apellido, fuenteDatos));
