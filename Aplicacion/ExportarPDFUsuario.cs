...
namespace Aplicacion
{
    public class ExportarPDFUsuario
    {
        ...
        public class Manejador: IRequestHandler<Consulta, Stream>{
            ...
            {
                //Origen de los Datos
                var customers =  await context.Vusuarios1.ToListAsync();
                ...
                document.Open();
                document.AddTitle("Reporte de Usuario");
                ...
                PdfPCell celdaID = new PdfPCell(new Phrase("Id Usuario", fuenteEncabezado));
                ...
                PdfPCell celdaTelefono = new PdfPCell(new Phrase("Cargo", fuenteEncabezado));
                ...
                foreach(var customer in customers){
                    ...
                    PdfPCell celdaDatoPhone = new PdfPCell(new Phrase(customer.Cargo.ToString(), fuenteDatos));
